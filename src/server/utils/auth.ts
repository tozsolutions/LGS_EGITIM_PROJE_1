...
export class AuthUtils {
  ...
  static generateTokens(payload: object) {
    ...
    const accessToken = jwt.sign(payload as any, config.jwt.secret as jwt.Secret, accessOptions);
    const refreshToken = jwt.sign(payload as any, config.jwt.secret as jwt.Secret, refreshOptions);
