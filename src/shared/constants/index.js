...
exports.LGS_EXAM_CONFIG = exports.FILE_UPLOAD = exports.PAGINATION = exports.USER_ROLES = exports.DIFFICULTY_LEVELS = exports.SUBJECTS = exports.SUCCESS_MESSAGES = exports.ERROR_MESSAGES = exports.HTTP_STATUS = exports.API_ROUTES = void 0;
exports.API_ROUTES = {
    AUTH: {
        LOGIN: '/auth/login',
    ...
    QUESTIONS: {
        ...
        BY_SUBJECT: (subject) => `/questions/subject/${subject}`,
    ...
    EXAMS: {
        ...
        ATTEMPT_BY_ID: (id) => `/exams/attempts/${id}`
    },
    MATERIALS: {
        BASE: '/materials',
        BY_ID: (id) => `/materials/${id}`,
        BY_SUBJECT: (subject) => `/materials/subject/${subject}`,
